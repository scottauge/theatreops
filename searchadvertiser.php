...
// $Header: file:///Users/scottauge/Documents/SVN/theatre/searchadvertiser.php 31 2019-08-09 03:09:48Z scottauge $
...
if ($_POST["Delete"] == "Delete") {
	...
	$SQL = "SELECT * FROM Advertisers WHERE AdvertiserName LIKE '%$SearchName%'";
    ...
    while ($Data = $Results->fetch_array(MYSQLI_ASSOC)) {
		...
		if ($_POST[$Data["RecID"]] == "on") {
			$Advertiser = new clsAdvertisers($DB);
			$Advertiser->FindByID($Data["RecID"]);
			$Advertiser->Delete();
		}
...
<title><?php print($Parameter->Value) ?> - Search Advertiser</title>
</head>

<!--
$Id: searchadvertiser.php 31 2019-08-09 03:09:48Z scottauge $
/**************************************************************************/
/*                                                                        */
...
<div align="center">
  <table width="50%" border="0">
    ...
    <?php
	$SQL = "SELECT * FROM Advertisers WHERE AdvertiserName LIKE '%$SearchName%' order by AdvertiserName";
    ...
    <tr bgcolor="<?php echo $RowColor ?>">
      ...
      <td><a href="updateadvertiser.php?RecID=<?php print $Data["RecID"] ?>"><?php print $Data["AdvertiserName"] ?></a></td>
    </tr>
