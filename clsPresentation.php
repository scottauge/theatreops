...
// on Thursday, 18-Feb-2021 13:52:18 EST 
...
class clsPresentation extends clsUtil {
  ...
  public $RecID;
  public $Title;
  public $BuildStartDate;
  public $DirectorRecID;
  public $RunStartDate;
  public $RunEndDate;
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO presentation (RecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM presentation WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function Update () {
    ...
    //
      ...
      $this->BuildStartDate = stripslashes($this->BuildStartDate);
      $this->DirectorRecID = stripslashes($this->DirectorRecID);
      $this->RunStartDate = stripslashes($this->RunStartDate);
      $this->RunEndDate = stripslashes($this->RunEndDate);
    ...
    $SQL = "UPDATE presentation SET Title = ?, BuildStartDate = ?, DirectorRecID = ?, RunStartDate = ?, RunEndDate = ? WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("ssssss", $this->Title, $this->BuildStartDate, $this->DirectorRecID, $this->RunStartDate, $this->RunEndDate,$this->RecID);
    $S->execute();
    $S->close();  
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT RecID, Title, BuildStartDate, DirectorRecID, RunStartDate, RunEndDate FROM presentation WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->RecID, $this->Title, $this->BuildStartDate, $this->DirectorRecID, $this->RunStartDate, $this->RunEndDate);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT RecID, Title, BuildStartDate, DirectorRecID, RunStartDate, RunEndDate FROM " . $SQL;
    ...
    $this->_S->bind_result($this->RecID, $this->Title, $this->BuildStartDate, $this->DirectorRecID, $this->RunStartDate, $this->RunEndDate);
