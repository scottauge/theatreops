...
// on Thursday, 18-Feb-2021 13:53:32 EST 
...
class clsPartToInventoryLocation extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO parttoinventorylocation (RecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM parttoinventorylocation WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function Update () {
    ...
    //
      ...
      $this->InventoryLocationRecID = stripslashes($this->InventoryLocationRecID);
      $this->PartRecID = stripslashes($this->PartRecID);
    ...
    $SQL = "UPDATE parttoinventorylocation SET InventoryLocationRecID = ?, PartRecID = ?, Quantity = ? WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("ssis", $this->InventoryLocationRecID, $this->PartRecID, $this->Quantity,$this->RecID);
    $S->execute();
    $S->close();  
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT RecID, InventoryLocationRecID, PartRecID, Quantity FROM parttoinventorylocation WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->RecID, $this->InventoryLocationRecID, $this->PartRecID, $this->Quantity);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT RecID, InventoryLocationRecID, PartRecID, Quantity FROM " . $SQL;
    ...
    $this->_S->bind_result($this->RecID, $this->InventoryLocationRecID, $this->PartRecID, $this->Quantity);
