...
// on Saturday, 23-Jun-2018 15:34:05 EDT 
// $Header: file:///Users/scottauge/Documents/SVN/theatre/clsParameter.php 2 2019-06-20 18:03:22Z scottauge $
//
...
class clsParameter extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO Parameter (RecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM Parameter WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function Update () {
    ...
    $SQL = "UPDATE Parameter SET Name = ?, Value = ? WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("sss", $this->Name, $this->Value,$this->RecID);
    $S->execute();
    $S->close();  
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT RecID, Name, Value FROM Parameter WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->RecID, $this->Name, $this->Value);
  ...
  // --------------------------------------------------------------------------
  // Main way of finding this
  // --------------------------------------------------------------------------
  
  public function FindByName ($Name) {
  
    $SQL = "SELECT RecID, Name, Value FROM Parameter WHERE Name = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $Name);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT RecID, Name, Value FROM " . $SQL;
    ...
    $this->_S->bind_result($this->RecID, $this->Name, $this->Value);
