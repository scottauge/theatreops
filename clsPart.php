...
// on Thursday, 18-Feb-2021 14:27:31 EST 
...
class clsPart extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO part (RecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM part WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function Update () {
    ...
    //
      ...
      $this->ItemNumber = stripslashes($this->ItemNumber);
    ...
    $SQL = "UPDATE part SET Category = ?, ItemNumber = ?, Description = ?, ImageURL = ? WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("sssss", $this->Category, $this->ItemNumber, $this->Description, $this->ImageURL,$this->RecID);
    $S->execute();
    $S->close();  
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT RecID, Category, ItemNumber, Description, ImageURL FROM part WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->RecID, $this->Category, $this->ItemNumber, $this->Description, $this->ImageURL);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT RecID, Category, ItemNumber, Description, ImageURL FROM " . $SQL;
    ...
    $this->_S->bind_result($this->RecID, $this->Category, $this->ItemNumber, $this->Description, $this->ImageURL);
