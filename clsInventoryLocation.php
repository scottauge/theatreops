...
// on Thursday, 18-Feb-2021 13:58:20 EST 
...
class clsInventoryLocation extends clsUtil {
  ...
  public function Create () {
    ...
    $SQL = "INSERT INTO inventorylocation (RecID) VALUES (?)";
  ...
  public function Delete () {
    ...
    $SQL = "DELETE FROM inventorylocation WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
  ...
  public function Update () {
    ...
    //
      ...
      $this->Building = stripslashes($this->Building);
      $this->Room = stripslashes($this->Room);
      $this->Shelving = stripslashes($this->Shelving);
      $this->Shelf = stripslashes($this->Shelf);
      $this->Slot = stripslashes($this->Slot);
    ...
    $SQL = "UPDATE inventorylocation SET Building = ?, Room = ?, Shelving = ?, Shelf = ?, Slot = ? WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("ssssss", $this->Building, $this->Room, $this->Shelving, $this->Shelf, $this->Slot,$this->RecID);
    $S->execute();
    $S->close();  
  ...
  public function FindByID ($ID) {
    ...
    $SQL = "SELECT RecID, Building, Room, Shelving, Shelf, Slot FROM inventorylocation WHERE RecID = ?";
    $S = $this->DB->Connection->prepare($SQL);
    $S->bind_param("s", $ID);
    ...
    $S->execute();
    $S->store_result();
    $S->bind_result($this->RecID, $this->Building, $this->Room, $this->Shelving, $this->Shelf, $this->Slot);
  ...
  public function FindByQuery ($SQL, $ArrayArgs) {
    ...
    $SQL = "SELECT RecID, Building, Room, Shelving, Shelf, Slot FROM " . $SQL;
    ...
    $this->_S->bind_result($this->RecID, $this->Building, $this->Room, $this->Shelving, $this->Shelf, $this->Slot);
